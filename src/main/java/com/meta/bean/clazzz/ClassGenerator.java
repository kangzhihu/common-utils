...
public class ClassGenerator {
    ...
    {
        return new ClassGenerator(getClassPool(ClassUtils.getCallerClassLoader(ClassGenerator.class)));
    }
    ...
    public Class<?> toClass()
    {
        ...
        try
        {
            ...
            return mCtc.toClass(ClassUtils.getCallerClassLoader(getClass()), null);
        }
