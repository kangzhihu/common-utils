...
public final class ReflectUtils {
    ...
    //public static final Pattern GETTER_METHOD_DESC_PATTERN = Pattern.compile("get([A-Z][_a-zA-Z0-9]*)\\(\\)(" 修复mongo中_id 问题
    public static final Pattern GETTER_METHOD_DESC_PATTERN = Pattern.compile("get([A-Z_][_a-zA-Z0-9]*)\\(\\)("
            + DESC_REGEX + ")");

    public static final Pattern SETTER_METHOD_DESC_PATTERN = Pattern.compile("set([A-Z_][_a-zA-Z0-9]*)\\((" + DESC_REGEX
            + ")\\)V");

    public static final Pattern IS_METHOD_DESC_PATTERN = Pattern
            .compile("(?:is)([A-Z][_a-zA-Z0-9]*)\\(\\)Z");
    ...
    public static Class<?> getGenericClass(Class<?> cls, int i) {
        try {
            ...
            if (genericClass instanceof ParameterizedType) { // 澶勭悊澶氱骇娉涘瀷
                return (Class<?>) ((ParameterizedType) genericClass).getRawType();
            } else if (genericClass instanceof GenericArrayType) { // 澶勭悊鏁扮粍娉涘瀷
    ...
    public static Method findMethodByMethodName(Class<?> clazz, String methodName) throws NoSuchMethodException,
    ...
    public static boolean isBeanPropertyReadMethod(Method method) {
        return method != null
                ...
                && ((method.getName().startsWith("get") && method.getName().length() > 3) || (method.getName()
                .startsWith("is") && method.getName().length() > 2));
    }
